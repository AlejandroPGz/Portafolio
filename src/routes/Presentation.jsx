    ...
    return (
        <>
            <div className='w-full flex justify-center items-center max-h-max'>
                <div className='w-2/4 max-w-max flex flex-col gap-2 justify-center items-center text-center max-h-max h-40 mt-6'>
                    <h3 className='text-2xl font-medium text-zinc-900'>Alejandro Paradiso</h3> 
                    <h4 className='text-xl font-medium text-zinc-800 mb-2'>{t("profession")}</h4>
                </div>
            </div>
