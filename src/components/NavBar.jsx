...
export default function NavBar() {
  ...
  <nav className="w-full h-12 bg-zinc-400 flex flex-row items-center justify-between px-4 xl:justify-around fixed top-0 left-0 z-10">
        ...
        <div className={`md:hidden absolute top-12 left-0 w-full bg-zinc-50 rounded-b-lg flex flex-col items-center justify-center transform transition-transform py-3
