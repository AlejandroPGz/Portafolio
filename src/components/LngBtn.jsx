...
export default function LngBtn() {
  ...
  return (
        <button
        onClick={changeLng}
        className="text-base font-medium text-zinc-600 md:text-zinc-200 hover:bg-zinc-100 hover:text-zinc-500 px-2 py-1 rounded-xl flex flex-row justify-center items-center gap-1">
